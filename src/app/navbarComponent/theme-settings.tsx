...
export function Theme() {
  ...
  return (
    <Card className="user-navbar-container user-navbar-padding">
      ...
      <Card className="home-portfolio-gap flex">
      ...
      <Card className="user-input-gap">
        <Card>
          <Card>
            <div className="relative w-full max-w-md">
              ...
              <Input
                className="pl-9 searchButtonLandingPage placeholder:text-inputPlaceholder bg-searchBar "
                type="search"
                placeholder="Search..."
        ...
        >
          <SelectTrigger
            ...
            className="w-[180px] bg-currencyContainer selectCurrencyLandingPage flex space-between"
          >
            <div className="currency-icon bg-currencyIconContainer text-currencyIcon">
              {usd}
            </div>
            <SelectValue
              placeholder={`
